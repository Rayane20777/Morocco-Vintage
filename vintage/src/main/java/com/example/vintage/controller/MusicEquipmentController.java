...
public class MusicEquipmentController {
    ...
    @PostMapping
    public ResponseEntity<MusicEquipmentResponseDTO> createMusicEquipment(@ModelAttribute MusicEquipmentRequestDTO dto) {
    ...
    public ResponseEntity<MusicEquipmentResponseDTO> updateMusicEquipment(
            ...
            @ModelAttribute MusicEquipmentRequestDTO dto) {
